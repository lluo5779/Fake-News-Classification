...
def simlex_analysis(word_vectors):
	...
	f_out_simlex = open("./pipeline/bash_files/results/simlex_ranking.txt", "wb")
	f_out_counterfitting = open("./pipeline/bash_files/results/counter_ranking.txt", "wb")
...
def run_experiment(config_filepath):
	...
	print_word_vectors(transformed_word_vectors, "./pipeline/bash_files/results/counter_fitted_vectors.txt")
